...
local advancedOptionsLocales = {
    ...
    ["Questie is under active development for Project Epoch! Please check Discord or Github for latest info! (https://github.com/esurm/Questie)"] = {
        ["ptBR"] = "Questie is under active development for Project Epoch! Please check Discord or Github for latest info! (https://github.com/esurm/Questie)",
        ["ruRU"] = "Questie is under active development for Project Epoch! Please check Discord or Github for latest info! (https://github.com/esurm/Questie)",
        ["deDE"] = "Questie is under active development for Project Epoch! Please check Discord or Github for latest info! (https://github.com/esurm/Questie)",
        ["koKR"] = "Questie is under active development for Project Epoch! Please check Discord or Github for latest info! (https://github.com/esurm/Questie)",
        ["esMX"] = "Questie is under active development for Project Epoch! Please check Discord or Github for latest info! (https://github.com/esurm/Questie)",
        ["enUS"] = true,
        ["zhCN"] = "Questie is under active development for Project Epoch! Please check Discord or Github for latest info! (https://github.com/esurm/Questie)",
        ["zhTW"] = "Questie is under active development for Project Epoch! Please check Discord or Github for latest info! (https://github.com/esurm/Questie)",
        ["esES"] = "Questie is under active development for Project Epoch! Please check Discord or Github for latest info! (https://github.com/esurm/Questie)",
        ["frFR"] = "Questie is under active development for Project Epoch! Please check Discord or Github for latest info! (https://github.com/esurm/Questie)",
    },
    ["Skip Validation"] = {
